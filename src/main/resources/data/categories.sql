...
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000102', 'Electricity',           'EXPENSE', '00000000-0000-0000-0000-000000000001', now(), now());
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000103', 'Gas & Heating',         'EXPENSE', '00000000-0000-0000-0000-000000000001', now(), now());
...
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000504', 'Books & Magazines',  'EXPENSE', '00000000-0000-0000-0000-000000000005', now(), now());
...
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000604', 'Household Supplies',     'EXPENSE', '00000000-0000-0000-0000-000000000006', now(), now());
...
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000702', 'Books & Supplies','EXPENSE', '00000000-0000-0000-0000-000000000007', now(), now());
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000703', 'Online Courses',  'EXPENSE', '00000000-0000-0000-0000-000000000007', now(), now());
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000704', 'Student Loan',    'EXPENSE', '00000000-0000-0000-0000-000000000007', now(), now());
...
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000d01', 'Work-Travel',     'EXPENSE', NULL, now(), now());
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000d02', 'Work-Restaurant', 'EXPENSE', NULL, now(), now());
INSERT INTO categories (id, name, type, parent_id, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000d03', 'Work-Hotel',      'EXPENSE', NULL, now(), now());
